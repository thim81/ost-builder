    ...
    extend: {
      colors: {
        ...
        outcome: {
          ...
          light: 'hsl(var(--outcome-light))',
          foreground: 'hsl(var(--outcome-foreground))',
        },
        opportunity: {
          DEFAULT: 'hsl(var(--opportunity))',
          light: 'hsl(var(--opportunity-light))',
        ...
        experiment: {
          ...
          light: 'hsl(var(--experiment-light))',
          foreground: 'hsl(var(--experiment-foreground))',
        },
        canvas: {
          bg: 'hsl(var(--canvas-bg))',
          dot: 'hsl(var(--canvas-dot))',
        },
        connector: 'hsl(var(--connector-line))',
        status: {
